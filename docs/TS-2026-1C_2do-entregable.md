...
```
2. Elaborar un resumen de hasta 100 palabras que plantee los objetivos del
...
3. Proponer un modelo de referencia ( _benchmark_ ). ¿Qué desempeño tiene dicho
...
4. Analizar el proceso con las funciones de autocorrelación parcial y
...
5. Evaluar al modelo estocástico y abordar las siguientes actividades:
...
6. Definir un modelo que emplee redes neuronales para la predicción en los pasos
    ...
    (ej, normalización).
7. Evaluar el modelo de NN y abordar las siguientes actividades:
